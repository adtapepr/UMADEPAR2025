        ...
        <section id="adquirir" className="py-12 sm:py-16 md:py-20 lg:py-32 bg-gradient-to-br from-[#d9d9d9] via-white to-[#d9d9d9] text-[#0f2b45] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            ...
            <div className="text-center" data-aos="fade-up">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto mb-8 sm:mb-12">
                  ...
                  <div className="bg-[#0f2b45] backdrop-blur-sm border-2 border-[#edbe66]/30 rounded-2xl p-4 sm:p-6 hover:border-[#edbe66] hover:shadow-xl transition-all duration-300 group">
                    <div className="text-center mb-3 sm:mb-4">
                      ...
                      <p className="text-2xl sm:text-3xl font-black text-white">R$ 35<span className="text-base sm:text-lg">,00</span></p>
                      <p className="text-[#edbe66] font-bold text-xs sm:text-sm">Até 15/01/2025</p>
                    </div>
                  ...
                  <div className="bg-white/90 backdrop-blur-sm border-2 border-gray-300/50 rounded-2xl p-4 sm:p-6">
                    <div className="text-center mb-3 sm:mb-4">
                      ...
                      <p className="text-2xl sm:text-3xl font-black text-[#0f2b45]">R$ 45<span className="text-base sm:text-lg">,00</span></p>
                      <p className="text-[#0f2b45]/60 font-bold text-xs sm:text-sm">16/01 - 31/01/2025</p>
                    </div>
                    <div className="text-center">
                      <p className="text-[#0f2b45]/70 text-xs sm:text-sm mb-1 sm:mb-2">💰 Preço intermediário</p>
                      <p className="text-[#0f2b45]/70 text-xs sm:text-sm">Ainda um bom negócio</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/90 backdrop-blur-sm border-2 border-gray-300/50 rounded-2xl p-4 sm:p-6 sm:col-span-2 md:col-span-1">
                    <div className="text-center mb-3 sm:mb-4">
                      ...
                      <p className="text-[#0f2b45]/60 font-bold text-xs sm:text-sm">01/02 - 15/02/2025</p>
                    </div>
                    <div className="text-center">
                      <p className="text-[#0f2b45]/70 text-xs sm:text-sm mb-1 sm:mb-2">🔥 Última oportunidade</p>
                      <p className="text-[#0f2b45]/70 text-xs sm:text-sm">Não perca!</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* CTA */}
              <div className="max-w-md mx-auto" data-aos="zoom-in" data-aos-delay="400">
                <Link 
                  to="/venda-jovem" 
